...
class TimeSettingGeneralScreen extends StatefulWidget {
  @override
  _TimeSettingGeneralScreenState createState() => _TimeSettingGeneralScreenState();
}

class _TimeSettingGeneralScreenState extends State<TimeSettingGeneralScreen> {
  final ServiceData serviceData = ServiceData();
  String? selectedTime;

  final List<TimeOption> timeOptions = [
    TimeOption('1 hour', 'Standard session', Icons.access_time, '1_hour_standard'),
    TimeOption('2 hour', 'Extended session', Icons.schedule, '2_hour_extended'),
  ];
